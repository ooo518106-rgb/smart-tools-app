...
tool_choice = st.sidebar.radio("اختر الأداة", [
    ...
    "💳 رسوم تابي وتمارا (جديد)",
    "💬 صانع روابط واتساب (جديد)",
    "🏦 حاسبة القروض والأقساط (جديد)",
    "🕋 حاسبة زكاة المال (جديد)",
    "💸 حاسبة الرواتب",
...
if tool_choice == "📦 حاسبة التجارة الإلكترونية (مع الذاكرة)":
    ...
    if len(st.session_state.ecommerce_history) > 0:
        ...
        with col_btn1:
            st.download_button(label="📥 تحميل السجل (Excel)", data=csv_data, file_name="Ecommerce_Calculations.csv", mime="text/csv")
        with col_btn2:
...
# ==========================================
# 2. حاسبة رسوم تابي وتمارا (جديد)
# ==========================================
elif tool_choice == "💳 رسوم تابي وتمارا (جديد)":
...
# ==========================================
# 3. صانع روابط واتساب (جديد)
# ==========================================
elif tool_choice == "💬 صانع روابط واتساب (جديد)":
    st.title("💬 صانع روابط واتساب المباشرة")
    st.write("اصنع رابطاً مباشراً لبدء محادثة واتساب معك بضغطة زر (ممتاز لروابط البايو في تيك توك وإنستقرام).")
...
# ==========================================
# 4. حاسبة القروض والأقساط (جديد)
# ==========================================
elif tool_choice == "🏦 حاسبة القروض والأقساط (جديد)":
...
# ==========================================
# 5. حاسبة زكاة المال (جديد)
# ==========================================
elif tool_choice == "🕋 حاسبة زكاة المال (جديد)":
    ...
    st.info("💡 ملاحظة: يتم إخراج زكاة المال إذا بلغ المال 'النصاب' ومضى عليه سنة هجرية كاملة.")
